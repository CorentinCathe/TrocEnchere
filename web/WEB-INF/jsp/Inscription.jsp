        ...
        <div class="form">
            <form id="inscription-form" action="${pageContext.request.contextPath}/inscription" method="post">
                ...
                <div class="form-item">
                    ...
                    <input pattern="[0-9]{5}" type="text" id="codePostal" name="cp" placeholder="Code Postal" required/>
                </div>
                <div class="form-item">
                ...
                <div class="form-item">
                    ...
                    <input type="password" placeholder="Confirmer mot de passe" id="confirmPassword"
